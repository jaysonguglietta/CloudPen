...
export class RequestSecurityError extends Error {
  constructor(public readonly status: 400 | 403 | 413 | 415 | 429, message: string) {
    super(message);
  }
}
...
export function safeApiError(error: unknown): Response {
  ...
  const status = [400, 401, 403, 413, 415, 429].includes(candidateStatus) ? candidateStatus : 500;
