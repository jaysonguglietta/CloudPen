...
| Supply chain | Pinned Actions, CodeQL, Dependabot, dependency audit, SBOM, deterministic release package, separate SLSA provenance and CycloneDX attestations, and retained Sigstore bundles | CI and predicate-specific `gh attestation verify` checks on a tagged release |
